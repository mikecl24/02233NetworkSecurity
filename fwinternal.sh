...
iptables -A FORWARD -p TCP -s $usernet -d $intadmin --dport 110 -j DROP
iptables -A FORWARD -p TCP -d $usernet -s $intadmin --sport 995 -j ACCEPT
iptables -A FORWARD -p TCP -d $usernet -s $intadmin --sport 110 -j DROP
